...
- [x] 26. Checklist di lancio: pagina 404, CTA in cima alla home e fissa sul telefono, meta title/description e OpenGraph assoluti su ogni pagina, favicon anche su timer/display, robots.txt e sitemap.xml dal database, alt sulle immagini, breakpoint mobile verificati (tabella cookie sistemata), schede e righe di caricamento, errori sul singolo campo, pagina di ringraziamento (iscrizione e ritorno dal pagamento, .ics), privacy/termini/cookie (bozze da far verificare), avviso privacy, statistiche senza cookie con cruscotto admin, termini accettati alla registrazione, scarica dati / elimina account in Le mie iscrizioni
